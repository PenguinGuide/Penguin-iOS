#
#  Be sure to run `pod spec lint PGLaunchAds.podspec' to ensure this is a
...
s.name         = "PGLaunchAds"
s.version      = "1.0"
s.summary      = "PenguinGuide Launch Ads manager"
s.description  = "PenguinGuide Launch Ads manager"
