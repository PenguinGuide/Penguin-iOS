...
- (void)setCellWithGood:(PGGood *)good
{
    ...
    if (good.originalPrice && ![good.originalPrice isEqualToString:@"0"]) {
        ...
        [attrS addAttribute:NSForegroundColorAttributeName value:Theme.colorExtraHighlight range:NSMakeRange(good.discountPrice.length+2, good.originalPrice.length)];
